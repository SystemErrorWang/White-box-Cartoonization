...
class Unet_Generator(nn.Module):
    ...
    def __init__(self, channel=32):
        ...
        self.Conv_1 = nn.Conv2d(channel, channel, 3, 2, 1)
        self.Conv_2 = nn.Conv2d(channel, 2*channel, 3, 1, 1)
        self.Conv_3 = nn.Conv2d(2*channel, 2*channel, 3, 2, 1)
        self.Conv_4 = nn.Conv2d(2*channel, 4*channel, 3, 1, 1)
        ...
        self.Conv_5 = nn.Conv2d(4*channel, 2*channel, 3, 1, 1)
        self.Conv_6 = nn.Conv2d(2*channel, 2*channel, 3, 1, 1)
        self.Conv_7 = nn.Conv2d(2*channel, channel, 3, 1, 1)
        self.Conv_8 = nn.Conv2d(channel, channel, 3, 1, 1)
